...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '1000/day',  # Increased from 500/day
        'user': '5000/day',  # Increased from 2000/day
        'login': '50/min',   # Increased from 20/min
    }
}

# JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),  # Increased from 1 hour
    ...
    'SLIDING_TOKEN_LIFETIME': timedelta(hours=2),  # Increased from 1 hour
    'SLIDING_TOKEN_REFRESH_LIFETIME': timedelta(days=7),  # Increased from 1 day
}
